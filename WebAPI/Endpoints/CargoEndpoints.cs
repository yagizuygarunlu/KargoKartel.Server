...
namespace KargoKartel.Server.WebAPI.Endpoints
{
    public static class CargoEndpoints
    {
        public static void MapCargoEndpoints(this IEndpointRouteBuilder app)
        {
            ...
            group.MapGet("/cargos", async (ICargoRepository cargoRepository) =>
            {
            ...
            group.MapPost("/cargos", async (ISender sender, CargoCreateCommand request, CancellationToken cancellationToken) =>
            {
